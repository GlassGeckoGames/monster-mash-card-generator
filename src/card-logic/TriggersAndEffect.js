...
export const triggersAndEffects = [
  ...
  },
  {
    ...
    effects: [
      ...
      { name: "This card has a 50% chance to either attack every card on the field or attack itself. (33% chance instead if 5 or more alive players exist)." },
    ],
  },
  {
  ...
  },
  {
    ...
    effects: [
      ...
      { name: "You can choose to attach that discarded card to this one, so long as you have space for it." },
    ],
  },
  {
